...
/** Reusable teammate phone visual; call behavior stays in FarmerIntake. */
      ...
      <div className="rounded-[28px] border border-neutral-300 bg-[#2b2f2c] p-4 pb-5 shadow-[0_4px_16px_rgba(26,34,28,0.10)]">
        ...
        <div className="mt-4 grid grid-cols-3 gap-x-3 gap-y-2">
          {[
            ...
            >
              <div className="text-[13px] font-medium leading-none text-[#e8e4dc]">{digit}</div>
              {letters && <div className="mt-0.5 text-[7px] leading-none tracking-[0.08em] text-[#9aa39b]">{letters}</div>}
            </div>
          ))}
        </div>
      </div>
