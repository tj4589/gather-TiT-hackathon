  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-75px)] max-w-6xl flex-col justify-center px-6 py-12 sm:py-20">
      <div className="max-w-xl">
        ...
        <Link to="/request" onClick={clearActiveDemoSession} className="mt-9 inline-flex w-full items-center justify-center gap-2 rounded-[10px] border border-transparent bg-green px-5 py-3 text-[15px] font-medium text-cream transition-colors duration-150 hover:bg-green-700 sm:w-auto">Request supply <ArrowRight size={17} strokeWidth={1.8} /></Link>
